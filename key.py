"""Keyboard and mouse handlers, along with constants. A key sate handler can
...
class Keys(EventDispatcher):
    ...
    def on_key_press(self, keys, modifiers):
        ...
        self.data[keys] = True
        self.data[modifiers] = True

    def on_key_release(self, keys, modifiers):
        """Called as an event when a key is released. This is used to update the
        key state handler.
...
_key_names = {}
_motion_names = {}
_motion_combinations = {
    (KEY_UP, False):        MOTION_UP,
    (KEY_RIGHT, False):     MOTION_RIGHT,
    (KEY_DOWN, False):      MOTION_DOWN,
    (KEY_LEFT, False):      MOTION_LEFT,
    (KEY_RIGHT, True):      MOTION_NEXT_WORD,
    (KEY_LEFT, True):       MOTION_PREVIOUS_WORD,
    (HOME, False):          MOTION_BEGINNING_OF_LINE,
    (END, False):           MOTION_END_OF_LINE,
    (PAGEUP, False):        MOTION_PREVIOUS_PAGE,
    (PAGEDOWN, False):      MOTION_NEXT_PAGE,
    (HOME, True):           MOTION_BEGINNING_OF_FILE,
    (END, True):            MOTION_END_OF_FILE,
    (BACKSPACE, False):     MOTION_BACKSPACE,
    (DELETE, False):        MOTION_DELETE,
    (C, True):              MOTION_COPY,
    (V, True):              MOTION_PASTE
}
...
def motions_combinations(motion):
    """Return a keyboard combination describing a text motion. These motions
    ...
    return _motion_combinations.get(motion)
